package com.example.application.views.marketoverview;


import com.example.application.views.MainLayout;
import com.example.application.views.marketoverview.ServiceHealth.Status;
...
@Route(value = "Market-Overview", layout = MainLayout.class)
@PermitAll
public class MarketOverviewView extends Main {

    public MarketOverviewView() {
        addClassName("market-overview-view");
